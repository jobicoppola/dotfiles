" Also see the vim script ./color_demo.vim, which displays all 256 cterm
" colors by appending them to the current buffer - to run it, do:
" :so ~/.vim/colors/color_demo.vim

" List of names for the 256 default colors in xterm
